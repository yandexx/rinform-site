...
В английской версии Информа библиотека единая, но в русской версии пришлось разнести её на два отдельных проекта. На данный момент Glulx находится в стадии беты и рекомендуется для авторов, уже имевших опыт с Информом.
